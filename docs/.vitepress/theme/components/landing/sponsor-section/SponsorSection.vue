...
<template>
  <div class="sponsor-section">
    ...
    <img
      ...
      height="55"
    />
    <h2>Gratuita &amp; Código Aberto</h2>
    <h4>
      Vite é licenciada pela MIT e será sempre gratuita e de código aberto. Isto é possível graças aos nossos colaboradores e estas empresas:
    </h4>

    <h4>Trazida até nós por</h4>
    <div class="voidzero">
