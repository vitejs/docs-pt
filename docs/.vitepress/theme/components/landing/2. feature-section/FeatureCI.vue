...
<template>
  ...
  >
    ...
    <div class="feature__meta meta--center">
      <div class="meta__title">Integração Contínua do Ecossistema</div>
      <div class="meta__description">
        Nossa integração contínua testa continuamente as alterações da Vite em relação aos projetos a jusante, permitindo-nos melhorar a Vite com estabilidade e confiança.
      </div>
    </div>
  </div>
</template>
