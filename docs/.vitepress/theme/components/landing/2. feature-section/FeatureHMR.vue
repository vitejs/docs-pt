  ...
  >
    ...
    <div class="feature__meta meta--center">
      <div class="meta__title">
        Substituição de Módulo Instantânea Extremamente Rápida
      </div>
      <div class="meta__description">
        Substituição de Módulo Instantânea que se mantém rápida independentemente do tamanho da aplicação.
      </div>
    </div>
  </div>
</template>
