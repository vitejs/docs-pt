<template>
  <div class="get-started-section">
    ...
    <h2>Começar a Construir com a Vite</h2>
    <h3>
      Precisamos preparar-nos para um ambiente de desenvolvimento que possa finalmente acompanhar a velocidade da nossa mente.
    </h3>
