...
<template>
  ...
  >
    ...
    <div class="feature__meta">
      <div class="meta__title">Sistema de Extensões Flexível</div>
      <div class="meta__description">
        As extensões da Vite ampliam a interface de extensão bem projetada da Rollup com algumas opções adicionais específicas da Vite.
      </div>
    </div>
  </div>
</template>
