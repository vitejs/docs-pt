  ...
  <div class="hero">
    <div class="container">
      ...
      <a
        ...
        target="_blank"
      >
        <img src="/viteconf.svg" alt="Logótipo da Viteconf" width="20" height="20" />
        <span>Palestras da ViteConf 2024</span>
      </a>

      <!-- Heading -->
      <h1>A Ferramenta de Construção<br />para a Web</h1>
      <!-- Tagline -->
      <h3>
        Vite é uma ferramenta de construção do front-end extremamente rápida que alimenta a próxima geração de aplicações da Web.
      </h3>

      <!-- CTA Buttons -->
      <div class="hero__actions">
        <a href="/guide/" class="btn btn--primary">Começar</a>
        <a
